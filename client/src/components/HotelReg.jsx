  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
        <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
            <img className='w-1/2 rounded-xl hidden md:block' src={assets.regImage} alt="reg-img" />

            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                <img className='absolute top-4 right-4 h-4 w-4 cursor-pointer' src={assets.closeIcon} alt="cloce-icon" />
                ...
                <div className='w-full mt-4'>
                    <label className='font-medium text-gray-500' htmlFor="phone">Phone</label>
                ...
                <div className='w-full mt-4 max-x-60 mr-auto'>
                ...
                <button className='bg-indigo-500 hover:bg-indigo-600 transition-all text-white mr-auto rounded px-6 py-2 cursor-pointer mt-6'>Register</button>
            </div>
        </form>
    </div>
  )
